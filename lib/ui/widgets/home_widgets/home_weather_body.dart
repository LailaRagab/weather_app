  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text("update at: ${weatherModelThird.updateDate.hour}:${weatherModelThird.updateDate.minute}", style: AppFonts.updateDetails),
        const SizedBox(
          height: 40,
        ),
        Row(
          ...
          children: [
            Image(image: weatherModelThird.imageIcon.contains("https:") ?
            NetworkImage(weatherModelThird.imageIcon) : NetworkImage("https:${weatherModelThird.imageIcon}") ),
            Text("${weatherModelThird.avgTemp}", style: AppFonts.weatherDetails),
            Column(
              children: [
                Text(
